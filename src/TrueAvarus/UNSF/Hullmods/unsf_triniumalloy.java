...
public class unsf_triniumalloy extends BaseHullMod {
	...
	public static float MANEUVER_PENALTY = 2f;
	
	public static float SMOD_MANEUVER_PENALTY = 5f;
...
//		mag.put(HullSize.CAPITAL_SHIP, 400f);
		...
		mag.put(HullSize.DESTROYER, 450f);
		mag.put(HullSize.CRUISER, 550f);
		mag.put(HullSize.CAPITAL_SHIP, 650f);
	}
