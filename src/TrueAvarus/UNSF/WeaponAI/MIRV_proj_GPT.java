...
public class MIRV_proj_GPT implements MissileAIPlugin, GuidedMissileAI {

    private static final float ACTIVATION_DELAY = 1.5f;
    ...
    private final float WAVE_TIME = 0;
    ...
    private final int MAX_SEARCH_RANGE = 1000;
